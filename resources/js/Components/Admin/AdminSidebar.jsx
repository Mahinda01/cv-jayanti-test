...
export default function AdminSidebar() {
    ...
    const menuItems = [
        ...
        { label: 'Data Produk', href: '/admin/produk', icon: Package },
        ...
        { label: 'Piutang Pelanggan', href: '/admin/piutang', icon: CreditCard },
        { label: 'Laporan', href: '/admin/laporan', icon: FileText },
        { label: 'Manajemen Akun', href: '/admin/users', icon: UserCog },
    ];
