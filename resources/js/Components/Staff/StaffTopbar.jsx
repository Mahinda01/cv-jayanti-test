...
export default function StaffTopbar({
    ...
    return (
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white transition-colors duration-300 dark:border-[#334155] dark:bg-[#1d293d]">
            <div className="flex min-h-[64px] items-center justify-between gap-4 px-6">
                <div className="flex min-w-0 flex-1 items-center gap-5">
                    ...
                    {showSearch && (
                        <div className="relative hidden min-w-0 max-w-[760px] flex-1 lg:block">
                            <Search
                                size={17}
