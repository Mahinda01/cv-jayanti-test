...
export default function Create({ products = [], customers = [] }) {
    ...
    const getItemPurchaseSubtotal = (item) => {
        ...
        return Number(product.purchase_price || 0) * Number(item.quantity || 0);
    };
    ...
    const getItemProfit = (item) => {
        return getItemSubtotal(item) - getItemPurchaseSubtotal(item);
    };

    const totalPurchaseAmount = data.items.reduce((total, item) => {
        return total + getItemPurchaseSubtotal(item);
    }, 0);
    ...
    const totalProfit = totalAmount - totalPurchaseAmount;
                ...
                <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="mb-4 flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-xs font-medium text-slate-500 dark:text-gray-400">
                                    Harga beli dan harga jual mengikuti data produk saat transaksi dibuat.
                                </p>
                            </div>
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="min-w-12 text-xs font-bold text-slate-500 dark:text-gray-400">
                                                            {product
                                                                ? product.unit
                                                                : ''}
                                                        </span>
                                                ...
                                                <td className="whitespace-nowrap px-4 py-3 text-right text-xs font-extrabold text-green-600 dark:text-green-400">
                                                    {formatRupiah(
                                                        getItemProfit(item),
                                                    )}
                                                </td>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-[#334155] dark:bg-[#1d293d]">
                            ...
                            <p className="mt-2 text-xl font-extrabold text-green-600 dark:text-green-400">
